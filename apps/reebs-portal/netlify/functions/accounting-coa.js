 ...
 * GET    /.netlify/functions/accounting-coa              — list all accounts
 * GET    /.netlify/functions/accounting-coa?id=N         — single account with balances
 * POST   /.netlify/functions/accounting-coa              — create account (non-system only)
 * PATCH  /.netlify/functions/accounting-coa              — update account (name/active only; code/type locked after use)
 */
