 ...
 *
 * GET  /.netlify/functions/accounting-journals               — list journals
 * GET  /.netlify/functions/accounting-journals?id=N          — single journal with lines
 * POST /.netlify/functions/accounting-journals               — create draft journal + lines
 * PATCH /.netlify/functions/accounting-journals              — post (action:"post") or reverse (action:"reverse")
 */
