 ...
 *
 * GET   /.netlify/functions/accounting-import              — list all batches with status
 * GET   /.netlify/functions/accounting-import?id=N         — single batch with journals
 * POST  /.netlify/functions/accounting-import              — create batch + auto-generate journals from monthly summary
 * PATCH /.netlify/functions/accounting-import              — post all journals in a batch (action:"post")
