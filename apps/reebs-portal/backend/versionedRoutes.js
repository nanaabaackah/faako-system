...
export const REEBS_V1_HANDLER_ALIASES = Object.freeze({
  ...
  "/api/v1/auth/bootstrap/status": "accountAccess",
  "/api/v1/auth/bootstrap": "accountAccess",
  "/api/v1/auth/invitations": "accountAccess",
  "/api/v1/auth/invitations/accept": "accountAccess",
