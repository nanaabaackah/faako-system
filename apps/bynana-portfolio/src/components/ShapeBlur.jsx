...
import '../styles/components/ShapeBlur.css';
...
function ShapeBlur({
  ...
  useEffect(() => {
    ...
    const update = () => {
      ...
      vMouseDamp.x = THREE.MathUtils.damp(vMouseDamp.x, vMouse.x, 8, deltaTime);
      vMouseDamp.y = THREE.MathUtils.damp(vMouseDamp.y, vMouse.y, 8, deltaTime);
