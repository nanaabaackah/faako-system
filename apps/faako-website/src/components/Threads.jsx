...
import "../styles/components/threads.css";
...
export default function Threads({
  ...
  useEffect(() => {
    ...
    const lineColor = Array.isArray(color) && color.length === 3 ? color : [1, 1, 1];
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        uColor: { value: new Vec3(lineColor[0], lineColor[1], lineColor[2]) },
