      ...
      <div className="about-page">
        ...
        <section className="about-hero">
          ...
          <div className="about-hero__content">
            ...
            <div className="about-hero__actions" aria-label="About page actions">
              <Link to="/contact" className="about-hero__button about-hero__button--primary">
                Contact Stroane
              </Link>
              <Link to="/services" className="about-hero__button about-hero__button--secondary">
                View Services
              </Link>
            </div>
          </div>
        ...
        <section className="about-story">
          <div className="about-story__grid" data-scroll-reveal="">
          ...
          <div className="about-beliefs">
            <article className="bubble-card about-belief-card about-belief-card--blue" data-scroll-reveal="">
            ...
            <article className="bubble-card about-belief-card" data-scroll-reveal="">
        ...
        <section className="about-values">
          ...
          <div className="about-values__list" data-scroll-reveal="">
            {values.map((value, index) => (
              <div key={value.title} className="about-value-row" data-scroll-reveal="">
        ...
        <section className="about-cta">
          <div className="about-cta__content" data-scroll-reveal="">
            <img
        ...
        <section className="about-audience">
          <div className="about-section-intro" data-scroll-reveal="">
            <h2 className="section__heading">
          ...
          <div className="about-audience__grid">
            {businessGroups.map((group) => (
              <div key={group.title} className="about-group" data-scroll-reveal="">
